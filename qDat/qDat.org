...
pick their 5\,\% quantile. Given that there are $46.7\times 10^6$
mappability values, the 5\% quantile is entry number
\[
46.7\times 10^6/100\times 5\approx 2,335,000.
\]
...
\begin{figure}
  ...
  \caption{Two measures of uniqueness along a portion of human
    ...
    \emph{Mappbaility}; the dashed lines show the respective
