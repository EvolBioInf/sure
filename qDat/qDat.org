...
(accession LOC105369308) and 36,700,516-36,709,131 (LOC107985492),
and the gene encoding the transcription factor SIM2 located at
36,699,115--36,749,917. SIM2 is a master regulator of neurogenesis and
this whole region is part of the chromosomal region associated with
Down syndrome.
...
unique region, ``u'', and the coordinates of the three genes mentioned
above, ``g1'', ``g2'', and ``g3''.
#+end_export
#+begin_src sh <<qDat.sh>>=
...
\begin{figure}
  ...
  \caption{Two measures of uniqueness along a portion of human
    ...
    (\emph{u}), and the tree genes that intersect this region,
    LOC105369308 (\emph{g1}), SIM2 (\emph{g2}), and LOC107985492
    (\emph{g3}).}\label{fig:chr21}
\end{figure}
#+end_export
#+begin_src sh <<qDat.sh>>=
